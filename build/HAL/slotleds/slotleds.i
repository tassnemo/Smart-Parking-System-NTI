# 0 "HAL/slotleds/slotleds.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "HAL/slotleds/slotleds.c"
...
# 3 "HAL/slotleds/slotleds.c" 2
# 1 "APP/config.h" 1
# 4 "HAL/slotleds/slotleds.c" 2
